...
def custom_screenshot(region=None):
    tmp_file = "/tmp/virtual_display_screenshot.png"
    subprocess.run("xwd -display :99 -root -silent | convert xwd:- png:" + tmp_file, shell=True, check=True)
...
pyautogui.screenshot = custom_screenshot
pyscreeze.screenshot = custom_screenshot
